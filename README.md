...
Current data includes District, Housing, BMC, Superior, Juvenile, Probate and Family, Land, Appeals, and Supreme Judicial Court records; the city/county/neighborhood jurisdiction rules in `jurisdiction_rules.json`; Boston ward/BMC geometry; and the Massachusetts ZIP lookup table, used both for compatibility work and to expand ZIP-only addresses.
